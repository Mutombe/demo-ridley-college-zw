              ...
              <SectionReveal delay={0.2}>
                <div className="flex flex-wrap gap-2 mb-10">
                  {firstService.features.map((feature) => (
                    <span
                      key={feature}
                      className="bg-gold-500/10 text-gold-300 px-3 py-1.5 rounded-none text-xs font-semibold border border-gold-500/20 backdrop-blur-sm"
                    >
                      {feature}
                    </span>
                  ))}
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2 mb-8">
                        {service.features.map((feature) => (
                          <span
                            key={feature}
                            className="bg-gold-500/10 text-gold-700 px-3 py-1.5 rounded-none text-xs font-semibold"
                          >
                            {feature}
                          </span>
                        ))}
