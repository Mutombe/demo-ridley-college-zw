                ...
                <div className="relative bg-earth-50/50 border border-earth-100 rounded-none overflow-hidden">
                  ...
                  <div className="relative p-6 sm:p-8 md:p-10 pl-7 sm:pl-10 md:pl-12">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 mb-6 sm:mb-8">
                      ...
                      {/* Social proof badge */}
                      <div className="flex items-center gap-2 bg-green-50 border border-green-100 text-green-700 px-3 py-1.5 rounded-none text-xs font-medium flex-shrink-0 w-fit">
                      ...
                      <div>
                        ...
                        <div className="flex gap-3">
                          <button
                            ...
                            className={`flex-1 flex items-center justify-center gap-2.5 py-3.5 rounded-none text-sm font-semibold border-2 transition-all duration-300 ${
                              sendMethod === 'email'
            ...
            <div className="lg:col-span-2 space-y-4 sm:space-y-6">
              ...
              <SectionReveal direction="left">
                <div className="bg-navy-900 text-white rounded-none p-6 sm:p-8 relative overflow-hidden">
                  ...
                  <div className="absolute -top-12 -right-12 w-32 h-32 bg-gold-500/5 rounded-none blur-2xl" />
