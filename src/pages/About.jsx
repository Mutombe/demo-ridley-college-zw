                    ...
                    <div className={`relative flex items-start sm:items-center gap-4 sm:gap-0 ${
                      ...
                      <div className="hidden sm:flex absolute left-1/2 -translate-x-1/2 z-10">
                        <motion.div
                          ...
                          className="w-4 h-4 bg-gold-500 rounded-none ring-4 ring-white shadow-md"
                        />
                      </div>
                      ...
                      <div className="sm:hidden flex-shrink-0 z-10">
                        <motion.div
                          ...
                          viewport={{ once: true }}
                          transition={{ duration: 0.4, delay: index * 0.1 + 0.2 }}
                          className="w-3 h-3 bg-gold-500 rounded-none ring-4 ring-white shadow-md mt-2 ml-[18px]"
                        />
                      </div>
